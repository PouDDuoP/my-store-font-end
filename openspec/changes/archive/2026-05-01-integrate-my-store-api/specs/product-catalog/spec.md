...
(Previously: System fetched products from https://api.escuelajs.co/api/v1/products)
...
(Previously: Product used `title`, `images[]`, `creationAt`, `category` object)
...
(Previously: Product service used api.escuelajs.co URL with constructor injection)
